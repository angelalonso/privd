...
#        if state != 'deleted':
#            self.status[sync_folder_path][local_file]['local_file_checksum'] = checksum(local_file)
#            self.status[sync_folder_path][local_file]['local_file_timestamp'] = tstamp(local_file)
#            self.status[sync_folder_path][local_file]['remote_file_checksum'] = checksum(real_remote_file)
...
#                    if not checksum(obj) == self.local[sync_folder_path][obj]['local_file_checksum']:
...
#        self.local[sync_folder_path][local_file]['local_file_checksum'] = checksum(real_local_file)
#        try:
...
#        self.remote[sync_folder_path][remote_file]['remote_file_checksum'] = checksum(real_remote_file)
#        self.local[sync_folder_path][remote_file]['remote_file_timestamp'] = tstamp(real_remote_file)
#        self.local[sync_folder_path][remote_file]['remote_file_checksum'] = checksum(real_remote_file)
